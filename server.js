...
} from "./src/controller/file.controller.js";
...
io.on("connection", (socket) => {
  ...
  /** save text */
  socket.on(ACTIONS.SAVE_TEXT, ({ content, pageId }) => {
    console.log("update data", { content, pageId });
    setTimeout(async () => {
      const rs = await updatePageController(pageId, content);
      console.log("update", rs);
    }, 300);
  });
